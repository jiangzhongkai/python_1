...
在power_demand4的基础上对误差数据集进行扩展了，其他的和power_demand4差不多
...
if __name__ == '__main__':
	...
	np.savetxt('train_losses2.1.txt',np.array(train_losses))
	np.savetxt('test_losses2.1.txt',np.array(test_losses))
